...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                let that = this;
                this.$axios.post('mvc/picture/getPictureList').then(function (res) {
           ...
           handleEdit(index, row) {
               const that = this;
               this.$axios.post('mvc/picture/showPicture',{id:row.id}).then(function (res) {
                   that.$router.push("tuopu",res);
               }).catch(function (error) {
                   console.log(error);
               });
           },
            ...
            // 确定删除
            deleteRow(){
                this.$axios.post('mvc/picture/delete', {id:this.tableData[this.idx].id})
