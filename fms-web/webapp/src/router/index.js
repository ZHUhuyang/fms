    ...
    routes: [
        ...
        },
        {
            ...
            children:[
                ...
                {
                     path: '/tuopu',
                      component: resolve => require(['../components/page/fileparser/Tuopu.vue'], resolve),
                      meta: { title: '拓扑图' }
                },

                {
                    path: '/tuopuManage',
                    component: resolve => require(['../components/page/fileparser/TuopuManage.vue'], resolve),
                    meta: { title: '拓扑图管理' }
                },
                {
                  path: '/control',
                  component: resolve => require(['../components/page/fileparser/Control.vue'], resolve),
                   meta: { title: '控件管理' }
                },
                ...
                {
                    path: '/fileInput',
                    component: resolve => require(['../components/page/fileparser/fileInput.vue'], resolve),
                    meta: { title: '离线文件导入' }
                },
                {
                    //布局测试
